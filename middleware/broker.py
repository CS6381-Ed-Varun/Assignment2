...
class broker:
    ...
    def __init__(self):
        ...
        # setting
        self.zk_object.set(self.leader_node,
                           to_bytes(self.leader))  # setting the port info into the leader znode for pubs + subs
...
def main():
    ...
    print('Bound Broker Pub Side to tcp://10.0.0.1:5559')

    # sub side
    backend = context.socket(zmq.XSUB)
    backend.bind("tcp://10.0.0.1:5560")
    print('Bound Broker Sub Side to tcp://10.0.0.1:5559')
